...
<footer className="bg-white">
    <div className="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <form className="mt-4 sm:flex sm:max-w-md">
          ...
          <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
            <button type="submit" className="w-full bg-black flex items-center justify-center border border-transparent rounded-md py-2 px-4 text-base leading-6 font-medium text-white hover:bg-indigo-500 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
              Subscribe
            </button>
          </div>
        </form>
    ...
    <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
      ...
      <p className="mt-8 text-base leading-6 text-gray-400 md:mt-0 md:order-1">
        &copy; 2020 JS.Social, Inc. All rights reserved.
      </p>
    </div>
  </div>
</footer>
